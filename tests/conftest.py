...
def test_user(db_session):
    ...
    try:
        db_session.query(Query).filter_by(user_id=user.id).delete(synchronize_session=False)
...
def client(db_session):
    with patch("app.services.rag_service.RAGService.__init__", return_value=None), \
