...
ERROR_COUNT = Counter(
    "cliniq_http_errors_total", "Nombre total d'erreurs HTTP (4xx/5xx)", ["endpoint"]
)
...
CLINICAL_QUERY_COUNT = Counter(
    "cliniq_rag_queries_total", "Nombre total de questions posées au RAG"
)
...
RAG_NO_CONTEXT = Counter(
    "cliniq_rag_no_context_total", "Nombre de fois où aucun contexte n'a été trouvé"
)
